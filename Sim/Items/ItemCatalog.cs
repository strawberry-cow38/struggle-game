...
public static class ItemCatalog
{
    ...
    static ItemCatalog()
    {
        ...
        RocketFrag = RegisterItem("RocketFrag", "RPG-7 Frag Rocket", Ammo, weight: 2f, bulk: 2f, maxStack: 20,
        ...
        RocketHedp = RegisterItem("RocketHEDP", "RPG-7 HEDP Rocket", Ammo, weight: 2f, bulk: 2f, maxStack: 20,
        ...
        RocketIncend = RegisterItem("RocketIncend", "RPG-7 Incendiary Rocket", Ammo, weight: 2f, bulk: 2f, maxStack: 20,
